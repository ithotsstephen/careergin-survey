...
(38, 1, 'When someone asks, “What are you good at?” how confident do you feel answering?', 'radio', '', 1),
(39, 1, 'I feel I understand myself better than most people my age.', 'radio', '', 1),
(40, 1, 'I often feel confused about what kind of person I am becoming.', 'radio', '', 1),
(42, 1, 'I know my natural strengths beyond studies (communication, creativity, leadership, etc.).', 'radio', '', 1),
(43, 1, 'I feel confident in my abilities even when compared with others.', 'radio', '', 1),
(45, 1, 'When I succeed, I know why I succeeded.', 'radio', '', 1),
(46, 1, 'I clearly know what activities make me feel excited and energetic.', 'radio', '', 1),
(47, 1, 'I enjoy learning things outside school syllabus on my own.', 'radio', '', 1),
(48, 1, 'Sometimes I feel interested in things that adults around me don’t value much.', 'radio', '', 1),
(49, 1, 'I feel confused about choosing the “right” stream or future path.', 'radio', '', 1),
(50, 1, 'I worry about making a wrong decision that I cannot change later.', 'radio', '', 1),
(51, 1, 'I feel pressured to choose something even before I fully understand myself.', 'radio', '', 1),
(52, 1, 'I know about multiple career options beyond common ones.', 'radio', '', 1),
(53, 1, 'I understand what different careers actually involve in real life.', 'radio', '', 1),
(54, 1, 'I feel school teaches me enough about real career choices.', 'radio', '', 1),
(55, 1, 'I feel stressed when thinking about my future.', 'radio', '', 1),
(56, 1, 'I feel scared of disappointing my parents or family.', 'radio', '', 1),
(57, 1, 'I compare myself with friends and feel anxious.', 'radio', '', 1),
(58, 1, 'I can clearly imagine myself 10 years from now.', 'radio', '', 1),
(59, 1, 'My future feels exciting rather than scary.', 'radio', '', 1),
(60, 1, 'If given guidance, I believe I can do well in life.', 'radio', '', 1),
(61, 1, 'I wish someone explained careers in a simple, honest way.', 'radio', '', 1),
(62, 1, 'I want guidance that understands me, not just my marks.', 'radio', '', 1),
(63, 1, 'I feel confident about who I am becoming as a person.', 'radio', '', 1),
(64, 1, 'Which statement best describes you right now?', 'radio', '', 1),
(65, 1, 'I feel clear about the direction my life is moving in.', 'radio', '', 1),
(66, 1, 'Sometimes I feel I am just following a path chosen earlier without clarity.', 'radio', '', 1),
(67, 1, 'I am confident about the skills I can offer to the real world.', 'radio', '', 1),
(68, 1, 'I know what I am naturally good at beyond my degree.', 'radio', '', 1),
(69, 1, 'I struggle to explain my strengths during interviews or discussions.', 'radio', '', 1),
(70, 1, 'My current course fully matches my interests.', 'radio', '', 1),
(71, 1, 'I sometimes regret my course choice.', 'radio', '', 1),
(72, 1, 'I chose my course mainly due to', 'radio', '', 1),
(73, 1, 'I feel anxious about getting the “right” career after college.', 'radio', '', 1),
(74, 1, 'I fear being stuck in a job I don’t like.', 'radio', '', 1),
(75, 1, 'I worry about competition and job market uncertainty.', 'radio', '', 1),
(76, 1, 'My career decisions are strongly influenced by family expectations.', 'radio', '', 1),
(77, 1, 'I compare my progress with peers and feel pressure.', 'radio', '', 1),
(78, 1, 'I feel comfortable discussing my confusion openly with family.', 'radio', '', 1),
(79, 1, 'I fear changing direction even if I feel unsure now.', 'radio', '', 1),
(80, 1, 'I feel it is “too late” to rethink my career path.', 'radio', '', 1),
(81, 1, 'I wish I had better guidance earlier.', 'radio', '', 1),
(82, 1, 'I understand how my skills match real industry needs.', 'radio', '', 1),
(83, 1, 'I feel confused by too many career options and advice online.', 'radio', '', 1),
(84, 1, 'I know what steps I should take next for my career.', 'radio', '', 1),
(85, 1, 'If guided properly, I am open to re-aligning my career path.', 'radio', '', 1),
(86, 1, 'I believe understanding my strengths scientifically would help me.', 'radio', '', 1),
(87, 1, 'What is your biggest fear regarding your teen\'s career decision?', 'radio', 'Parent', 1),
(88, 1, 'How would you describe the current job market to your teen?', 'radio', 'Parent', 1),
(89, 1, 'What is your primary source of information about \"trending\" careers (e.g., AI, Data Science, Sustainability)?', 'radio', 'Parent', 1),
(90, 1, 'When you hear about a new \"trending course,\" what is your first reaction?', 'radio', 'Parent', 1),
(91, 1, 'How do you view a traditional professional degree (Engineering, Medicine, CA) today?', 'radio', 'Parent', 1),
(92, 1, 'What is your opinion about your teen starting their own business or venture?', 'radio', 'Parent', 1),
(93, 1, 'The concept of \"scope\" in a field mainly means to you:', 'radio', 'Parent', 1),
(94, 1, 'What is your understanding of a \"Psychometric Assessment\"?', 'radio', 'Parent', 1),
(95, 1, 'Would you consider a psychometric assessment for your teen?', 'radio', 'Parent', 1),
(96, 1, 'Who should have the MOST influence on the final career decision?', 'radio', 'Parent', 1),
(97, 1, 'What is the biggest barrier in discussing careers with your teen?', 'radio', 'Parent', 1),
(98, 1, 'How prepared do you feel to guide your teen in today\'s career landscape?', 'radio', 'Parent', 1),
(99, 1, 'When your teen says \"I don\'t know what I want to do,\" you feel:', 'radio', 'Parent', 1),
(100, 1, 'Which factor do you weigh most heavily when evaluating a career option?', 'radio', 'Parent', 1),
(101, 1, 'How do you validate information about a course\'s \"placement statistics\"?', 'radio', 'Parent', 1),
(102, 1, 'The idea of a \"gap year\" for career exploration is:', 'radio', 'Parent', 1),
(103, 1, 'What is your main concern about the cost of professional education?', 'radio', 'Parent', 1),
(104, 1, 'How much pressure do you feel from family/society regarding your teen\'s career choice?', 'radio', 'Parent', 1),
(105, 1, 'Seeing your teen stressed about career decisions makes you:', 'radio', 'Parent', 1),
(106, 1, 'In 10 years, what would you consider a \"successful\" outcome of this career decision?', 'radio', 'Parent', 1),
(108, 1, 'How important is \"passion\" versus \"practicality\" in your view?', 'radio', 'Parent', 1),
(109, 1, 'Do you believe the career your teen chooses now is for life?', 'radio', 'Parent', 1),
(110, 1, 'What support do you feel YOU need most right now?', 'radio', 'Parent', 1),
(111, 1, 'When should serious career planning ideally begin?', 'radio', 'Parent', 1),
(112, 1, 'Ultimately, my role as a parent in this process should be:', 'radio', 'Parent', 1);
